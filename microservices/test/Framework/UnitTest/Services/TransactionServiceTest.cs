namespace Transaction.Framework.UnitTest.Services
{
    ...
    {
        protected CustomerService TransactionServiceUnderTest { get; }
        protected Mock<IAccountSummaryRepository> AccountSummaryRepositoryMock { get; }
        protected Mock<IHttpClientWrapperRespository> AccountTransactionRepositoryMock { get; }
        protected Mock<ILogger<CustomerService>> LoggerMock { get; }
        ...
        public TransactionServiceTest()
        {
            ...
            AccountTransactionRepositoryMock = new Mock<IHttpClientWrapperRespository>();
